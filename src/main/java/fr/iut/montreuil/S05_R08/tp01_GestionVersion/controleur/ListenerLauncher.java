...
import fr.iut.montreuil.S05_R08.tp01_GestionVersion.modele.Console;
...
import fr.iut.montreuil.S05_R08.tp01_GestionVersion.vue.ArmeDescriptionSwitcher;
import fr.iut.montreuil.S05_R08.tp01_GestionVersion.vue.ItemDescriptionSwitcher;
import fr.iut.montreuil.S05_R08.tp01_GestionVersion.vue.modeleVue.TerrainVue;
        ...
        ChangeListener c = new ChangeListener() {
            ...
            public void changed(ObservableValue observable, Object oldValue, Object newValue) {
                switch (joueur.getNumeroZone()){
                    case "0":
                        if(joueur.isCollinding(9*16, 16) && (!joueur.getListeQuetes().getQueteActuelle().getTitre().startsWith("Chapitre 0") || joueur.getNombrePas() >= 5000))  {
