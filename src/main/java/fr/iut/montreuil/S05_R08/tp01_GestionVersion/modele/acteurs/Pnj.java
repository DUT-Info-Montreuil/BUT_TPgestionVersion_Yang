...
public class Pnj extends Acteur {
    ...
    public String getNextRepliques() {
    	String replique = getRepliques().get(numReplique);
    	numReplique++;
    	if(numReplique == getRepliques().size())
    		numReplique = 0;
        return replique;
    }
    ...
    public ArrayList<String> addRepliqueDeFin(String nom){
        ...
        switch (nom) {
            ...
            case "moine":
                ...
                break;
            case "spectre":
                endGameLine.add("Tu as réussi ! Si tu es le 1er a avoir réussi, fait une copie écran et va voir le professeur aigri, il aura un cadeau bonus pour toi. Va également voir Cloud il aura un conseil à te donner");
                break;
            case "vieux":
            ...
            case "luigi":
                ...
                break;
            case "cloud":
                endGameLine.add("Pour une recette de pates aux pesto, utilise des torsades, 2 tomates, 1 boule de mozarella, et 4 cuillères à soupe de fromage blanc");
                break;
            default:
                break;
        }
